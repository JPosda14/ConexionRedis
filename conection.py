...
class RedisExample:
    def __init__(self, host='localhost', port=6380, db=1):
...
if __name__ == "__main__":
    ...
    # Almacenar datos
    redis_example.set_data('frutas', 'aguacate')
    redis_example.set_data('frutas', 'pera')
    redis_example.set_data('frutas', 'manzana')
    redis_example.set_data('frutas', 'banano')
